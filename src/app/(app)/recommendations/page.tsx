      ...
      <div className="w-full md:w-[60%] mb-5 flex flex-col flex-wrap">
        ...
        <div className="flex flex-col font-body items-center justify-center gap-6 mt-8">
          <Text>
            ...
            um dos grandes segredos é usar um <strong>bom produto de pós-barba.</strong>
          </Text>
          ...
          <Text>
            O que achou deste guia? <strong>Ah, e não deixe de conferir
            nossas dicas mais detalhadas sobre cuidados com a barba para colocar
            em prática nossas dicas na sua rotina!</strong>
          </Text>
          <Button variant="link" href="/beard_tips">Conferir dicas</Button>
        </div>
      </div>
    </section>
  );
